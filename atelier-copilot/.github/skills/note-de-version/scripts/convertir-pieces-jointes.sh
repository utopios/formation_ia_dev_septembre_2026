...
# Une piece jointe Jira est souvent un .pdf, un .docx ou un .xlsx : un binaire.
# Le transmettre tel quel au modele coute cher en tokens (balisage, images,
# mise en forme) et emporte au passage des metadonnees que personne ne relit
# avant l'envoi : auteur, mentions de confidentialite, commentaires supprimes.
#
# La conversion est LOCALE et DETERMINISTE : aucune donnee ne part sur le
# reseau pendant cette etape. C'est la methode sobre en tokens du Module 2,
# empaquetee dans un skill.
#
# USAGE
#   ./convertir-pieces-jointes.sh <dossier> [dossier-sortie]
#
# Sans dossier de sortie, les .md sont ecrits a cote des sources.
#
# CODES DE SORTIE
#   0  au moins un fichier converti, ou rien a convertir
