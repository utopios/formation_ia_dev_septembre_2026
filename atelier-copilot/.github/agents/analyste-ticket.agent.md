...
tools: ['search', 'read', 'execute' ,'atlassian/jira_get_issue', 'atlassian/jira_search', 'atlassian/confluence_get_page', 'atlassian/confluence_search', 'atlassian/jira_download_attachments']
hooks:
  PreToolUse:
    - type: command
